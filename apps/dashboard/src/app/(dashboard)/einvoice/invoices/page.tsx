...
export default function InvoiceListPage() {
  ...
  const [activeTab, setActiveTab] = useState<'individual' | 'consolidated'>(
    (searchParams.get('tab') as any) || 'individual'
  )
    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
           ...
           {activeTab === 'consolidated' && stagedOrders.length > 0 && (
             <button 
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 bg-white p-4 rounded-[1.5rem] border border-gray-100 shadow-sm">
         <div className="flex p-1 bg-gray-50 rounded-2xl">
            <button 
              ...
              className={cn(
                ...
                activeTab === 'individual' ? "bg-white text-gray-900 shadow-sm" : "text-gray-400 hover:text-gray-600"
              )}
            >
            ...
            <button 
              ...
              className={cn(
                "flex items-center gap-2 px-6 py-2.5 rounded-xl text-xs font-black transition-all",
                activeTab === 'consolidated' ? "bg-white text-gray-900 shadow-sm" : "text-gray-400 hover:text-gray-600"
              )}
            >
               <Layers size={14} /> Consolidated
            </button>
         </div>
         ...
         <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <select 
              ...
              className="w-full sm:w-40 px-4 py-3 bg-gray-50 border-none rounded-2xl text-xs font-bold focus:ring-2 focus:ring-blue-600 appearance-none transition-all cursor-pointer border"
            >
